...
Control Atlas is a static, open-source, public-data-only reference workbench for the broader federal and DoD cyber compliance ecosystem. It helps practitioners understand public controls, baselines, STIGs, SRGs, CCIs, MITRE mappings, provenance, reciprocity, inheritance, and reusable authorization patterns before they begin organization-specific work.
