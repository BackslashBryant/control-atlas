...
**Not whole-product complete.** Deployed main `3e4e44902bff6cad52f23aef753e82e10f9e9e36` passed exact-head and merged-main CI, Pages deployment, live smoke, matching `release.json`, and focused six-width production verification. Official-source review, exact source-locator presentation, governed publication labels/currentness, DISA CCI taxonomy coverage, Atlas local-filter containment, human-first generated record identity, accessible human parent-source provenance, source-specific detail identity, truthful Source-detail return navigation, honest invalid Source recovery, and Resource-detail workspace restoration are shipped and live-verified. The active milestone makes Resource maintenance dates semantic and visually consistent without relabeling publisher dates as repository activity. Hands-on Android Chrome/TalkBack plus desktop NVDA evidence remains unavailable. The legacy `ashbryant.github.io` 404 is an external ownership limitation, not a product-code fix. No test, structural reconciliation, or emulated viewport is being promoted into those missing evidence classes.
...
| Publisher-field presentation | Met | Automated + live browser | Source text blocks, exact retained locators, procedure/config formats, governed publication names, separate source-check/publication-review evidence, copy behavior, human-first generated record identity, human parent-source inheritance explanations, and source-specific detail identity pass focused regressions. |
...
| Six-width route/template quality | Partial | Automated + local rendered browser + live browser | The route matrix is clean for page overflow, bounded rendering, Atlas local-filter containment, generated/native record identity, invalid Source recovery, and Resource-detail return/history behavior at 320, 375, 390, 768, 1024, and 1440. Resource maintenance date consistency remains tracked as POLISH-029. |
...
| Canonical live release | Met | CI + Pages + live browser | Release `3e4e44902bff6cad52f23aef753e82e10f9e9e36` passed exact-head and merged-main CI, fresh checkout, GitHub Pages, Pages Live Smoke, and the six-width live Resource-detail workspace regression. `release.json` matched the merged SHA. |
...
- Source detail and record facts now present `retrieved_at`, `last_checked`, and the governed publication review as separate evidence classes. The runtime summary reconciles all 27 review profiles; the production regression covers current, superseded, and multi-publication review states at the governed widths.
- Generated record identity is shipped and live-verified: canonical keys remain stable in routes and data while publisher-authored titles, human record types, and governed publication names lead headings, browse results, breadcrumbs, browser titles, related records, Atlas controls, and accessible names.
...
- Human parent-publication names, source-specific Source detail identity, truthful Source-detail return navigation, invalid Source recovery, and Resource-detail return uniformity are shipped and live-verified. The active milestone adds consistent Resource maintenance dates (POLISH-029), followed by continued source-backed taxonomy review without converting missing tags into negative applicability.
...
2. **Product and accessibility evidence**
   - Close POLISH-029 on semantic, consistent Resource maintenance dates while preserving exact source values.
