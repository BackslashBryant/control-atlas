...
| Six-width route/template quality | Partial | Automated + local rendered browser + live browser | The route matrix is clean for page overflow, bounded rendering, Atlas local-filter containment, generated/native record identity, and invalid Source recovery at 320, 375, 390, 768, 1024, and 1440. Resource-detail return uniformity remains tracked as POLISH-028. |
...
| Canonical live release | Met | CI + Pages + live browser | Release `6917572812c1b1ba6cb8811695ffc6497085b234` passed exact-head and merged-main CI, fresh checkout, GitHub Pages, Pages Live Smoke, and the six-width live invalid-Source recovery regression. `release.json` matched the merged SHA. |
...
- Human parent-publication names, source-specific Source detail identity, truthful Source-detail return navigation, and invalid Source recovery are shipped and live-verified. The active milestone adds Resource-detail return uniformity (POLISH-028), followed by continued source-backed taxonomy review without converting missing tags into negative applicability.
...
2. **Product and accessibility evidence**
   - Close POLISH-028 on Resource-detail navigation while preserving filtered workspace state.
