...
- [ ] **T8.3 Library** — use data-admin/sidebar application:
  - search is primary;
  - filters do not dominate;
  - results and selected record are distinct;
  - no raw IDs as labels.
- [ ] **T8.4 Record detail** — use knowledge-base/sidebar application:
...
- [ ] **T8.5 Atlas page shell** — use dashboard plus bounded deep-systems treatment:
