...
**Not whole-product complete.** Deployed main `a6156bff3fc932665f6c2b371279bf44b75f37e5` passed exact-head and merged-main CI, Pages deployment, live smoke, matching `release.json`, and focused six-width production verification. Official-source review, exact source-locator presentation, governed publication labels/currentness, DISA CCI taxonomy coverage, Atlas local-filter containment, human-first generated record identity, accessible human parent-source provenance, and source-specific detail identity are shipped and live-verified. The active milestone removes the duplicate return action from Source detail without losing the user's Sources workspace state. Hands-on Android Chrome/TalkBack plus desktop NVDA evidence remains unavailable. The legacy `ashbryant.github.io` 404 is an external ownership limitation, not a product-code fix. No test, structural reconciliation, or emulated viewport is being promoted into those missing evidence classes.
...
| Canonical live release | Met | CI + Pages + live browser | Release `a6156bff3fc932665f6c2b371279bf44b75f37e5` passed exact-head and merged-main CI, fresh checkout, GitHub Pages, Pages Live Smoke, and the six-width live Source-detail identity regression. `release.json` matched the merged SHA. |
...
- Human parent-publication names and source-specific Source detail identity are shipped and live-verified. The active milestone removes the duplicate Source-detail return action (POLISH-026); invalid-detail recovery (POLISH-027) and Resource-detail return uniformity (POLISH-028) remain next, followed by continued source-backed taxonomy review without converting missing tags into negative applicability.
...
2. **Product and accessibility evidence**
   - Close POLISH-026 through POLISH-028 on Source/Resource detail navigation and Source recovery while preserving filtered workspace state.
