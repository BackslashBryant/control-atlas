...
None — Epic 10 complete (zero residuals). See maintenance and optional RC promotion in Recommended Sequence.

## Epic Status (June 21, 2026)
...
| 10 — Atlas Map-First UX              | **Shipped**           | v2.2 + stability pass: persistent Cytoscape, incremental fCoSE on cluster expand/collapse, all-surface clustering, layout progress, zoom-tier labels — [`docs/plans/epic-10-atlas-map-ux.md`](plans/epic-10-atlas-map-ux.md). |
