...
const fixture = {
  ...
  nodes: [
    ...
    { id: 'nist-800-53:AC-4', node_type: 'control', label: 'AC-4 Information Flow Enforcement', source_id: 'nist-oscal', metadata: { catalog_id: 'nist-800-53', item_id: 'AC-4', title: 'Information Flow Enforcement', description: 'Control information flow.' } },
    ...
    { id: 'csf-2:PR.AA-02', node_type: 'requirement', label: 'PR.AA-02 Credential Governance', source_id: 'nist-oscal', metadata: { catalog_id: 'csf-2', item_id: 'PR.AA-02', title: 'Credential Governance', description: 'Govern credentials.' } },
    { id: 'disa-stig:V-100001', node_type: 'stig_rule', label: 'V-100001 Sample STIG Rule', source_id: 'disa-stig-library', metadata: { catalog_id: 'disa-stig', item_id: 'V-100001', title: 'Sample STIG Rule', description: 'Sample STIG rule.', severity: 'medium', benchmark_id: 'win11', benchmark_title: 'Windows 11 STIG' } },
  ...
  edges: [
    ...
    { id: 'edge:m2', source_node_id: 'nist-800-53:AC-3', target_node_id: 'csf-2:PR.AA-02', relationship_type: 'maps_to', provenance_class: 'federal_published', confidence: 'indirect', publication_status: 'candidate', evidence_ids: ['evidence:m2'], warning: 'Candidate relationship', inference_rule_id: 'sample-rule' },
    ...
    { id: 'edge:baseline-ac3', source_node_id: 'nist-800-53b:MODERATE', target_node_id: 'nist-800-53:AC-3', relationship_type: 'includes', provenance_class: 'federal_published', confidence: 'direct', publication_status: 'published', evidence_ids: ['evidence:baseline-ac3'] },
...
test('relationship exports mirror the current visible rows', () => {
  ...
  assert.match(csv, /"From ID","To ID","Relationship type","Source basis","Confidence","Rationale","Source references"/);
